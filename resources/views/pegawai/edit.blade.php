            ...
            <div class="card-body">
                <form action="{{ route('pegawai.update', $pegawai->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group my-2">
                        ...
                        @error('nama_pegawai') is-invalid @enderror" value="{{ $pegawai->nama_pegawai}}" autoFocus>
                    ...
                    <div class="form-group my-2">
                        ...
                        @error('bagian_id') is-invalid @enderror">
                            ...
                            @foreach ($bagians as $bagian)
                                <option value="{{ $bagian->id }}" {{ $pegawai->bagian_id == $bagian->id ? 'selected' : '' }}>
                                    {{ $bagian->nama_bagian }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div class="form-group my-2">
                        ...
                        @error('nik') is-invalid @enderror" value="{{ $pegawai->nik}}" readonly>
                        @error('nik') <small class="text-danger">{{ $message}}</small>@enderror
                    </div>
                    <div class="form-group my-2">
                        <label for="umur">Umur</label>
                        <input type="number" id="umur" name="umur" class="form-control
                        @error('umur') is-invalid @enderror" value="{{ $pegawai->umur}}">
                    ...
                    <div class="form-group my-2">
                        ...
                        @error('tempat_lahir') is-invalid @enderror" value="{{ $pegawai->tempat_lahir}}">
                    ...
                    <div class="form-group my-2">
                        ...
                        @error ('alamat') is-invalid @enderror">{{ $pegawai->alamat}}</textarea>
